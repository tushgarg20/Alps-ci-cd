...
class NoSelectableObject(RegistryException):
    ...
    def __str__(self):
        return ('args: %s, kwargs: %s\ncandidates: %s'
                % (self.args, list(self.kwargs.keys()), self.objects))
    ...
    * dictionary like access to an identifier will return the bare list of
    ...
    def __getitem__(self, name):
        ...
        try:
            ...
            raise ObjectNotFound(name)(None).with_traceback(sys.exc_info()[-1])
    ...
    def _select_best(self, objects, *args, **kwargs):
        ...
        if len(winners) > 1:
            ...
            if self.debugmode:
                ...
                raise Exception(msg % (winners, args, list(kwargs.keys())))
            self.error(msg, winners, args, list(kwargs.keys()))
    ...
    * the `GAEPersistentSessionManager` to replace the `PersistentSessionManager`
    ...
    def __getitem__(self, name):
        ...
        try:
            ...
            raise RegistryNotFound(name)(None).with_traceback(sys.exc_info()[-1])
    ...
    def load_module(self, module):
        ...
        if hasattr(module, 'registration_callback'):
            ...
            for objname, obj in list(vars(module).items()):
